...
class TemaTela:
    ...
    FONTES = {
        'pequena': lambda a: int(a * 0.04),
        'media': lambda a: int(a * 0.045),
        'grande': lambda a: int(a * 0.05),
        'extra_grande': lambda a: int(a * 0.06)
    }

    @staticmethod
    def criar_fonte(tamanho, altura_tela):
        return pygame.font.Font(None, tamanho(altura_tela))